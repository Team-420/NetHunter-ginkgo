...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	...
	git clone --depth 1 --no-single-branch https://github.com/team-420/AnyKernel3.git -b ginkgo
	msg "|| Cloning libufdt ||"
	git clone https://android.googlesource.com/platform/system/libufdt "$KERNEL_DIR"/scripts/ufdt/libufdt
	if [ $MODULES = "1" ]
	then
	    msg "|| Cloning Team420-modules ||"
	    git clone --depth 1 https://github.com/team-420/modules.git Mod
	fi
}
